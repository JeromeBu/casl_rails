...
bridge = GrownActivity.create!(title: "Bridge", max_participants: 50)
...
User.create!(email: "jerome@mail.com",admin: true, password: "qsdfjk", civility: "M." ,first_name: "Jérôme", last_name: "Burkard", address: "Paris", main_phone: "0678980000")
User.create!(email: "jerome2@mail.com", password: "qsdfjk", civility: "M." ,first_name: "Jérôme", last_name: "Burkard", address: "Paris", main_phone: "0678989090", activity_admin: "Judo")

Child.create!(first_name: "John", last_name: "Burkard", sex: "Garçon", birth_date: Date.new(1988, 9, 13), school: "Stan")
